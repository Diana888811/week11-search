...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=1305ace8972811c17e07d00f55d6116d&query=${userMovieTitle}`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=1305ace8972811c17e07d00f55d6116d&language=en-US';
    ...
    .then(axios.spread((movie, genres) => {
        ...
        for(let i = 0; i < movieGenreIds.length; i++){ //i++ on võrdne nagu i=i+1
